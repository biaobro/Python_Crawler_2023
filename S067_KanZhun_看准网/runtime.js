...
!function (i) {
				...
				var c = o.SHA512 = t.extend({
					...
					_doProcessBlock: function(e, t) {
						for (var n = this._hash.words, r = n[0], i = n[1], a = n[2], o = n[3], s = n[4], c = n[5], d = n[6], f = n[7], p = r.high, h = r.low, m = i.high, v = i.low, g = a.high, y = a.low, _ = o.high, b = o.low, w = s.high, x = s.low, M = c.high, k = c.low, S = d.high, T = d.low, L = f.high, C = f.low, D = p, E = h, O = m, P = v, I = g, N = y, A = _, Z = b, j = w, Y = x, R = M, H = k, F = S, z = T, B = L, W = C, V = 0; V < 80; V++) {
							...
							var de, fe = j & R ^ ~j & F, pe = Y & H ^ ~Y & z, he = D & O ^ D & I ^ O & I, me = E & P ^ E & N ^ P & N, ve = (D >>> 28 | E << 4) ^ (D << 30 | E >>> 2) ^ (D << 25 | E >>> 7), ge = (E >>> 28 | D << 4) ^ (E << 30 | D >>> 2) ^ (E << 25 | D >>> 7), ye = (j >>> 14 | Y << 18) ^ (j >>> 18 | Y << 14) ^ (j << 23 | Y >>> 9), _e = (Y >>> 14 | j << 18) ^ (Y >>> 18 | j << 14) ^ (Y << 23 | j >>> 9), be = u[V], we = be.high, xe = be.low, Me = B + ye + ((de = W + _e) >>> 0 < W >>> 0 ? 1 : 0), ke = ge + me;
							B = F,
							W = z,
							F = R,
							z = H,
				...
				var t = n
				  ...
				  , p = o.RIPEMD160 = a.extend({
					...
					_doProcessBlock: function(e, t) {
						...
						var a, o, p, b, w, x, M, k, S, T, L, C = this._hash.words, D = d.words, E = f.words, O = s.words, P = u.words, I = l.words, N = c.words;
						for (x = a = C[0],
						M = o = C[1],
						k = p = C[2],
						S = b = C[3],
	...
	90421: function(e, t, n) {
		(e = n.nmd(e)).exports = function() {
			...
			L = Object.keys ? Object.keys : function(e) {
				var t, n = [];
				for (t in e)
					u(e, t) && n.push(t);
				return n
			...
			var ge, ye = /\d/, _e = /\d\d/, be = /\d{3}/, we = /\d{4}/, xe = /[+-]?\d{6}/, Me = /\d\d?/, ke = /\d\d\d\d?/, Se = /\d\d\d\d\d\d?/, Te = /\d{1,3}/, Le = /\d{1,4}/, Ce = /[+-]?\d{1,6}/, De = /\d+/, Ee = /[+-]?\d+/, Oe = /Z|[+-]\d\d:?\d\d/gi, Pe = /Z|[+-]\d\d(?::?\d\d)?/gi, Ie = /[+-]?\d+(\.\d{1,3})?/, Ne = /[0-9]{0,256}['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFF07\uFF10-\uFFEF]{1,256}|[\u0600-\u06FF\/]{1,256}(\s*?[\u0600-\u06FF]{1,256}){1,2}/i;
			function Ae(e, t, n) {
			...
			F("k", ["kk", 2], 0, Qt),
			F("hmm", 0, 0, (function() {
				return "" + $t.apply(this) + Z(this.minutes(), 2)
			}
			)),
			F("hmmss", 0, 0, (function() {
				return "" + $t.apply(this) + Z(this.minutes(), 2) + Z(this.seconds(), 2)
			}
			)),
			F("Hmm", 0, 0, (function() {
			...
			function In(e, t, n) {
				return !e || At.indexOf(e) === new Date(t[0],t[1],t[2]).getDay() || (g(n).weekdayMismatch = !0,
				n._isValid = !1,
				!1)
			}
			function Nn(e, t, n) {
			...
			function Fn(e) {
				if (e._f !== i.ISO_8601)
					if (e._f !== i.RFC_2822) {
						...
						t = 0; t < r.length; t++)
							a = r[t],
							(n = (u.match(Ze(a, e)) || [])[0]) && ((o = u.substr(0, u.indexOf(n))).length > 0 && g(e).unusedInput.push(o),
			...
			function Gn(e) {
				var t = e._i;
				c(t) ? e._d = new Date(i.now()) : f(t) ? e._d = new Date(t.valueOf()) : "string" == typeof t ? Zn(e) : o(t) ? (e._a = p(t.slice(0), (function(e) {
			...
			i.RFC_2822 = function() {}
			;
			var Jn = T("moment().min is deprecated, use moment.max instead. http://momentjs.com/guides/#/warnings/min-max/", (function() {
			...
			function mr(e, t, n) {
				...
				if (null != e) {
					...
					this._isUTC = !0,
					null != r && this.add(r, "m"),
					a !== e && (!t || this._changeInProgress ? Ir(this, Cr(e - a, "m"), 1, !1) : this._changeInProgress || (this._changeInProgress = !0,
					i.updateOffset(this, !0),
			...
			function Cr(e, t) {
				...
				t ? a[t] = +e : a.milliseconds = +e) : (o = Tr.exec(e)) ? (n = "-" === o[1] ? -1 : 1,
				a = {
					y: 0,
					d: de(o[Ue]) * n,
					h: de(o[Ge]) * n,
			...
			function jr(e) {
				return k(e) || f(e) || Zr(e) || d(e) || Rr(e) || Yr(e) || null == e
			}
			function Yr(e) {
			...
			function ni(e, t) {
				return this.isValid() && (k(e) && e.isValid() || Kn(e).isValid()) ? Cr({
					to: this,
					from: e
			...
			var si = T("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", (function(e) {
			...
			ua.zoneAbbr = oa,
			ua.zoneName = sa,
			ua.dates = T("dates accessor is deprecated. Use date instead.", Qi),
			ua.months = T("months accessor is deprecated. Use month instead", dt),
			ua.years = T("years accessor is deprecated. Use year instead", gt),
			ua.zone = T("moment().zone is deprecated, use moment().utcOffset instead. http://momentjs.com/guides/#/warnings/zone/", vr),
			ua.isDSTShifted = T("isDSTShifted is deprecated. See http://momentjs.com/guides/#/warnings/dst-shifted/ for more information", xr);
			var fa = I.prototype;
			function pa(e, t, n, r) {
				var i = yn()
				  , a = m().set(r, t);
			...
			i.langData = T("moment.langData is deprecated. Use moment.localeData instead.", yn);
			var wa = Math.abs;
			function xa() {
				var e = this._data;
			...
			function La() {
				...
				return a >= 0 && o >= 0 && s >= 0 || a <= 0 && o <= 0 && s <= 0 || (a += 864e5 * Ta(Da(s) + o),
				o = 0,
				s = 0),
			...
			lo.locale = oi,
			lo.localeData = ui,
			lo.toIsoString = T("toIsoString() is deprecated. Please use toISOString() instead (notice the capitals)", uo),
			lo.lang = si,
			F("X", 0, 0, "unix"),
			F("x", 0, 0, "valueOf"),
			Ae("x", Ee),
...
function encrypt(id){
	a = M._A()
	data = {"encCompanyId":id}
	n = JSON.stringify(data)
	t = M.mA(n,{iv: a}).replace(/\//g, "_").replace(/\+/g, "-").replace(/=/g, "~")
	return [a,t]
}

// console.log(encrypt("1nx62929Eg~~"))


function decrypt(resp, kiv){
	decrypted = M.gy(resp, {iv:kiv})
	return JSON.parse(decrypted)
}

// kiv = "7DztvTbu4CFUuLH8"
// resp = ""
// console.log(decrypt(resp,kiv))